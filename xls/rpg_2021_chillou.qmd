...
<qgis version="3.30.2-'s-Hertogenbosch">
  ...
  <type>dataset</type>
  <title></title>
  <abstract>Couche parcellaires graphiques issue du RPG 2021 de la France métropolitaine du 01-01-2022, contient les surfaces parcellaires,leurs identifiants,surfaces,et le type et groupe de culture auquel elles appartiennent.

ATTENTION:Les parcelles peuvent contenir des artifacts géométriques tels des lignes à l'intérieur des polygones (ex:parcelle à l'id_parcel=18304379 de la table ref_agricole.ign_rpg_fr_2020_2154).
Création le 14/10/2022 par Yasmina MEZILET via ogr2ogr.
Modification le --/----</abstract>
  <contact>
    <name></name>
  ...
  <extent>
    <spatial crs="EPSG:2154" maxy="0" miny="0" minx="0" minz="0" dimensions="2" maxz="0" maxx="0"/>
    <temporal>
      <period>
        <start></start>
        <end></end>
